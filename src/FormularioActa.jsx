...
export default function FormularioActa({ onVolver }) {
  ...
  const [elabTexto, setElabTexto] = useState(""); // Firma/nombre/cargo combinado
  ...
  async function generarExcel() {
    setGenerando(true);
    try {
      const resp = await fetch("/plantilla-acta.xlsx");
      ...
      ws.getCell("A75").value = elabTexto;
      ws.getCell("E75").value = revTexto;
      ws.getCell("I75").value = aprTexto;
  ...
  return (
    <div className="min-h-screen" style={{ background: PAPER, fontFamily: "'IBM Plex Sans', system-ui, sans-serif" }}>
      ...
      <div className="p-4 max-w-xl mx-auto">
        ...
        <div className="border border-t-0 rounded-b-lg p-3 mb-4" style={{ borderColor: LINE }}>
          <Campo label="Elaboró / Contratista (Nombre y cargo)">
          ...
          <Campo label="Revisó / Supervisión (Nombre y cargo)">
          ...
          <Campo label="Aprobó / Contratante (Nombre y cargo)">
